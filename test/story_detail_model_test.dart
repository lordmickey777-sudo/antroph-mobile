...
void main() {
  test('StoryDetailDto parses example schema', () {
    ...
    expect(dto.riveElementId, 'toad_mascot');
    expect(dto.riveElement, isNotNull);
    expect(dto.riveElement!.name, 'Toad');
    expect(dto.riveElement!.expressionConfig['happy']?['eyeExpression'], 2);
